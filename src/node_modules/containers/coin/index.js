...
const coinSelector = (state, ownProps) => {
    console.log('id:', ownProps.match.params.id.toLowerCase());
    console.log('coins in store:', state.coin);
    console.log(
        'selected data:',
        R.prop(ownProps.match.params.id.toLowerCase(), state.coin)
    )

    return R.prop(ownProps.match.params.id.toLowerCase(), state.coin);
}
