                ...
                ? <div>
                        <div>
                                ...
                                <div className="header-overlay">
                                   <Menu />
                                    <div className="price-header-content">
                                        <h2 className="price-header-title">Gacex - Trading </h2>
                                    ...
                                    <div className="trade-form">
                                        ...
                                        <form action="get">
                                            ...
                                            <div className="trade-form-btn-container">
                                                ...
                                                }} className="green-btn">Button 1</button>
                            ...
                            <div className="balance-info">
                                <div className="wrapper">
                                    <h4><p className='colpb'>Balance Histori</p></h4><br/>
                                        <button className="footer-menu-btn1">Login</button><br/>
                                    <button className="footer-menu-btn1">Sign Up</button>
                                     <br/>       
                                </div>{/* wrapper */}
                            </div>{/* balance-info */}
