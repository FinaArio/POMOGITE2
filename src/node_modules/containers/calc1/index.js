...
class Calc_1 extends Component {
    ...
    render() {
        ...
        const willHave = this.state.volume * 3.2
                ...
                <div>
                    <div className="calc-header">
                        <div className="header-overlay">
                            ...
                            <div className="price-header-content">
                                ...
                                <p className="price-header-text">This is standart plan - 10% daily profit</p>
                            </div>{/* header-content */}
                        </div>{/* header-overlay */}
                    </div>{/* calc-header */}
                    <div className="calc-container">
                        <div className="wrapper">
                            ...
                            <button className="calc-item-btn">sign in</button>
                        </div>{/* wrapper */}
                    </div>{/* calc-container */}
...
export default connect(null, null)(Calc_1)